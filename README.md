...
| <a name="input_vmm_provider"></a> [vmm\_provider](#input\_vmm\_provider) | Type. Choices: `CloudFoundry`, `Kubernetes`, `Microsoft`, `OpenShift`, `OpenStack`, `Redhat`, `VMware`. | `string` | n/a | yes |
| <a name="input_virtual_domain"></a> [virtual\_domain](#input\_virtual\_domain) | Virtual domain name. | `string` | `""` | no |
